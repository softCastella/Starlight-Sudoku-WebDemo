                              ...
                              child: ListView(
                                ...
                                children: [
                                  ...
                                  ...SudokuDifficulty.values
                                      ...
                                      .map(
                                        (difficulty) => _DifficultyPathCard(
...
class _DifficultyPathCardState extends State<_DifficultyPathCard> {
  ...
  Widget build(BuildContext context) {
    ...
    return AnalyticsTapRegion(
      targetId: 'difficulty_${difficulty.name}',
      targetType: 'difficulty_card',
      child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Consumer<GameNotifier>(
                      builder: (context, gameNotifier, _) {
                        final completed = gameNotifier.completedStageCount(
                          difficulty,
                        );
                        return _MetaRow(
                          label: l10n.stages,
                          value: l10n.stagesCleared(
                            completed,
                            config.stageCount,
                          ),
                        );
